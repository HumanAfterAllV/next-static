...
import { ISearchPlantQueryVariables, ISearchPlantQuery } from '../generated/graphql';
...
export function useInfinitePlantSearch(args: InfinitePlantListArgs, options?: Options) {
    return useInfiniteQuery(['searchPlants', args], fetchPlants, {
        ...
        getNextPageParam: (lastPage) => {
            ...
            if (lastPageData === null || lastPageData === undefined) {
                return undefined;
            }
